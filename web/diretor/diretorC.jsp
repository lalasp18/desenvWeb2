...
<html>
    <head>
        ...
        <title>Locadora de Vídeo Passatempo - Cadastrar Diretor</title>
        
        <link rel="icon" href="${pageContext.request.contextPath}/img/ReelRover.png">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/diretorC.css">
    ...
    <body>
        ...
        <main class="mx-auto mt-5">
            ...
            <form id="meuFormulario" class="row g-3 needs-validation mx-auto mt-4" method="post" action="${pageContext.request.contextPath}/diretor-control/postar" novalidate>
                <div class="col-md-8">
            ...
            $(document).ready(function () {
                $("form").on("submit", function (event) {
                    ...
                    if(nome) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "${pageContext.request.contextPath}/diretor-control/postar",
                            data: formData,
                            ...
                            error: function () {
                                alert("Erro! Diretor não cadastrado.");
                            }
                        });
                    }
                });
